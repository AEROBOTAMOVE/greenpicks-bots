...
"✅ Около 14:30 и 23:30 — резултатите: кое позна, кое не, и целият ден накуп",
...
ROOM_PINS = {
    ...
    5: block(
        ...
        "Тук влизат <b>прогнозите за футбол</b>: избор, вероятност и числата зад мача.",
    ...
    9: block(
        ...
        "Около 14:30 — кое е познато дотук. Около 23:30 — финиш на деня:"
        " пуснати, познати, загубени, процент и разбивка по спорт.",
