...
"📊 Всеки фиш е <b>ПРОГНОЗА</b> от статистика — не гаранция, не „сигурен залог“.",
...
"⚽ 🏀 🏓 🏐 Спортните стаи — само срещите по направление",
...
ROOM_PINS = {
    3: block(
        ...
        "Как работи The Green Room + кодексът: банка, единица, дисциплина.",
        "Виж закачените обучителни постове. 18+."),
    4: block(
        "🎯 <b>ФИШОВЕ НА ДЕНЯ</b>",
        "Тук пише <b>САМО човекът-типстер</b>. Ботовете нямат достъп до тази стая.",
        "Формат: мач · пазар · коеф · логика.",
    ...
    27: block(
        ...
        "Прогноза от статистика, не гаранция. 18+."),
}
...
"",
"Отговаряме до 24ч. 💚 The Green Room"
)
