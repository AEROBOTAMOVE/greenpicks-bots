...
"📊 Всеки фиш е <b>прогноза</b>.",
"🔒 Нищо не трием. Загубите остават видими завинаги.",
"",
"<b>Какво тече в КАНАЛА:</b>",
"🎯 През деня — фишовете на типстъра (човека)",
# 🔴 ПОПРАВЕНО 11.08.2026. Стоеше „📊 21:00 — Обзорът на бота: числата за
# деня". Такъв обзор в 21:00 НЯМА и не е имало: дневният бот беше сведен до
# поглед напред, а обзорът на оценителя излиза в стая 9 около 14:30 и 23:30.
# Закачен текст в КАНАЛА, който обещава нещо в конкретен час, е обещание към
# всеки абонат — и се проверява от всеки.
# 🔴 15.09.2026: без часове — «какво излиза кога» не е за клиента.
"✅ Резултатите: кое позна, кое не, и целият ден накуп",
...
# 🔴 ПОПРАВЕНО 11.08.2026. Стоеше „Спортните стаи — само срещите". Точно
# обратното е вярно: predictor.py праща ВСЯКА карта и в стаята на своя спорт
# (SPORT_ROOM), а списъците със срещи са изключени по подразбиране
# (MATCHES_ROOM_LISTS=0). Тоест стените учеха човека да търси срещи там,
# където стоят прогнозите.
"⚽ 🏀 🎾 🏓 🏐 ⚾ 🥊 Стаите по спорт — прогнозите за този спорт",
"🤖 БОТА ПРЕДРИЧА — всички прогнози за деня",
...
ROOM_PINS = {
    3: block(
        ...
        "Какво има във всяка стая и как се чете картата.",
    ...
    5: block(
        "⚽ <b>ФУТБОЛ</b>",
        # 🔴 11.08.2026: звездите отпаднаха от картата — три звезди до 50%
        # се четяха като силна прогноза. Остана редът с 📚 за данните.
        "Тук влизат <b>прогнозите за футбол</b>: избор, процент и цената на мача.",
        "Новините са в стая 📰 Новини · всички спортове заедно — в 🤖 БОТА ПРЕДРИЧА."),
    6: block(
        "🏀 <b>БАСКЕТБОЛ</b>",
        "Тук влизат <b>прогнозите за баскетбол</b>: избор, процент и цената на мача.",
        "Новините са в стая 📰 Новини · всички спортове заедно — в 🤖 БОТА ПРЕДРИЧА."),
    7: block(
        "🏓 <b>ТЕНИС НА МАСА</b>",
        "Тук влизат <b>прогнозите за тенис на маса</b>: избор, процент и цената на мача.",
        "Новините са в стая 📰 Новини · всички спортове заедно — в 🤖 БОТА ПРЕДРИЧА."),
    8: block(
        "🏐 <b>ВОЛЕЙБОЛ</b>",
        "Тук влизат <b>прогнозите за волейбол</b>: избор, процент и цената на мача.",
        "Новините са в стая 📰 Новини · всички спортове заедно — в 🤖 БОТА ПРЕДРИЧА."),
    # 🔴 ПОПРАВЕНО 11.08.2026: обещаваше „отчет на типстъра", какъвто в кода
    # изобщо няма — отчита се само ботът.
    9: block(
        "✅ <b>РЕЗУЛТАТИ И СТАТИСТИКА</b>",
        # 🔴 15.09.2026: без часове и без махнатата разбивка по спорт.
        "Кое е познато и кое не — и целият ден накуп.",
        "Зелено печели / червено губи. Нищо не се трие."),
    # 🔴 И тук: от 11.08 стая 10 носи ФИШОВЕТЕ и как са минали, а числата
    # живеят в стая 9. Дотук пишеше „витрина само на спечелилите".
    10: block(
        "🏆 <b>ПЕЧЕЛИВШИ ФИШОВЕ</b>",
        "Тук се отчита всеки фиш: колко крака са минали и къде се е скъсал.",
        "Числата за целия ден — в ✅ Резултати и статистика."),
    11: block(
        "🆘 <b>ВЪПРОСИ И ПОМОЩ</b>",
    ...
    26: block(
        ...
        "🏓 Тенис на маса · 🏐 Волейбол · 🏀 Баскетбол · ⚽ Футбол · 🥊 Бойни спортове · 📰 Други спортове.",
    ...
    328: block(
        "🥊 <b>БОЙНИ СПОРТОВЕ</b>",
        "Тук влизат <b>прогнозите за бойни спортове</b>: UFC и PFL — бойци, избор, процент и цената на мача.",
        "Новините са в стая 📰 Новини · всички спортове заедно — в 🤖 БОТА ПРЕДРИЧА."),
}
...
# 🔴 ТЕКСТЪТ СЛЕДВА ИСТИНСКОТО СЪСТОЯНИЕ (15.09.2026). Дотук хокеят и
# американският футбол бяха ЗАКОВАНИ като «затворено до старта на сезона», а
# от 02.09 и двата играят и карти излизат в стаите им. Сега стената се избира
# по zatvoreni_sportove() от predictor — същия източник, който ползва пазачът.
NOVI_STAI_TEKST = {
    "hockey": block(
        "🏒 <b>ХОКЕЙ</b>",
        "Тук влизат <b>прогнозите за хокей</b>: избор, процент и цената на мача.",
        "Новините са в стая 📰 Новини · всички спортове заедно — в 🤖 БОТА ПРЕДРИЧА."),
    "tennis": block(
        "🎾 <b>ТЕНИС</b>",
        "Тук влизат <b>прогнозите за тенис</b>: избор, процент и цената на мача.",
        "Новините са в стая 📰 Новини · всички спортове заедно — в 🤖 БОТА ПРЕДРИЧА."),
    "baseball": block(
        "⚾ <b>БЕЙЗБОЛ</b>",
        "Тук влизат <b>прогнозите за бейзбол</b>: избор, процент и цената на мача.",
        "Новините са в стая 📰 Новини · всички спортове заедно — в 🤖 БОТА ПРЕДРИЧА."),
    "amfootball": block(
        "🏈 <b>АМЕРИКАНСКИ ФУТБОЛ</b>",
        "Тук влизат <b>прогнозите за американски футбол</b>: избор, процент и цената на мача.",
        "Новините са в стая 📰 Новини · всички спортове заедно — в 🤖 БОТА ПРЕДРИЧА."),
}
# Затворените стени остават за деня, в който спорт се затвори пак.
NOVI_STAI_ZATVORENO = {
    "hockey": block(
        "🏒 <b>ХОКЕЙ — затворено до старта на сезона</b>",
        "Стаята тръгва заедно с първите мачове — без да пита никого.",
        "Дотогава живите прогнози са в 🤖 БОТА ПРЕДРИЧА и в стаите на"
        " спортовете, които играят сега."),
    "amfootball": block(
        "🏈 <b>АМЕРИКАНСКИ ФУТБОЛ — затворено до старта на сезона</b>",
        "Стаята тръгва заедно с редовния сезон.",
        "Дотогава живите прогнози са в 🤖 БОТА ПРЕДРИЧА и в стаите на"
        " спортовете, които играят сега."),
}


def tekst_za_nova_staya(sport):
    """Стената на нова стая според ИСТИНСКОТО състояние на спорта."""
    try:
        _z = zatvoreni_sportove() or set()
    except Exception:                                        # noqa: BLE001
        _z = set()
    if sport in _z and sport in NOVI_STAI_ZATVORENO:
        return NOVI_STAI_ZATVORENO[sport]
    return NOVI_STAI_TEKST.get(sport)
...
def vlei_novite_stai():
    ...
    for sport, zapis in d.items():
        tekst = tekst_za_nova_staya(str(sport).strip())
...
"",
"<b>Често:</b>",
"• Фишът е прогноза, не сигурен изход.",
"• Показваме и загубите — прозрачност или нищо.",
"• Новините са в стая 📰 Новини · прогнозите — в стаята на своя спорт.",
"",
"💚 The Green Room"
)
...
def selftest():
    ...
    #
    # 🔴 ПАЗАЧЪТ БЕШЕ СЛЯП ЗА МЯСТОТО, КЪДЕТО ЛЪЖАТА НАИСТИНА БЕШЕ
    # (намерено 11.08.2026). Гледаше САМО ROOM_PINS и САМО с главни букви
    # („САМО срещите"). А изречението стоеше в HUB — текстът, който се закача
    # в КАНАЛА — и беше написано с малки: „само срещите и боевете".
    # Тоест проверка, написана точно срещу тази грешка, не можеше да я хване.
    # Сега гледа ВСИЧКИ текстове, които излизат навън, и без значение от
    # регистъра.
    _vsichki_tekstove = (list(ROOM_PINS.values()) + [HUB, SUPPORT_POST]
                         + list(NOVI_STAI_TEKST.values()))
    zastoyali = [t for t in _vsichki_tekstove
                 if "само срещите" in str(t).lower()
                 or "само предстоящите" in str(t).lower()]
    check("няма застояли текстове (само срещите)", not zastoyali)
    # И вторият край на същото: стените трябва да казват, че там има прогнози.
    check("HUB казва, че стаите по спорт носят прогнози",
          "прогнозите за този спорт" in HUB)
    # Затворен спорт НЕ бива да стои в редичката емоджита на HUB, нито в пина
    # на друга стая. Собствената му стена е изключение — там 🏒 е заглавие
    # („ХОКЕЙ — затворено до старта на сезона"), а не обещание за прогнози.
    ...
    for _s in (_zatv or ()):
        ...
        if not _e:
            continue
        check("HUB не обещава затворения " + _s, _e not in HUB)
        for _n, _txt in ROOM_PINS.items():
            check("пинът на стая " + str(_n) + " не обещава " + _s,
                  _e not in _txt or _txt == tekst_za_nova_staya(_s))
    ...
    # 🔴 ОБЪРНАТИ (15.09.2026). Дотук тук се ЗАКОВАВАШЕ, че хокеят и
    # американският футбол казват «затворено» — а те играят от 02.09 и карти
    # излизат в стаите им. Пазачът пазеше лъжата. Сега стената се сверява с
    # ИСТИНСКОТО състояние от predictor.py, в двете посоки.
    for s in ("hockey", "tennis", "baseball", "amfootball"):
        _txt = tekst_za_nova_staya(s) or ""
        if s in (_zatv or ()):
            check(s + ": затворен спорт — стената казва затворено", "затворено" in _txt)
            check(s + ": затворен спорт — стената НЕ обещава прогнози",
                  "Тук влизат <b>прогнозите" not in _txt)
        else:
            check(s + ": играещ спорт — стената обещава прогнози",
                  "Тук влизат <b>прогнозите" in _txt)
            check(s + ": играещ спорт — стената НЕ казва затворено",
                  "затворено" not in _txt)
    check("затворените стени са запазени за деня, в който потрябват",
          all("затворено" in NOVI_STAI_ZATVORENO[s] for s in ("hockey", "amfootball")))
    # 🔴 И ВЪТРЕШНОСТИТЕ НЕ СЕ ВРЪЩАТ (15.09.2026).
    _vatr = ("около 14:30", "около 23:30", "разбивка по спорт", "очакван резултат",
             "над/под", "брой геймове", "източник", "извадк", "от статистика")
    for _tt in _vsichki_tekstove + list(NOVI_STAI_TEKST.values()):
        for _d in _vatr:
            check("стената не казва «" + _d + "»", _d not in str(_tt).lower())
