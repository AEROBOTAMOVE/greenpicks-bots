...
FAQ = {
    "prognoza": (
        ...
        NL.join([
            ...
            "🏐 сила по разигравания · 🏓 процент победи от последните резултати.",
        ])),
    "zvezdi": (
        ...
        NL.join([
            ...
            # 🔴 ДВЕ НОВИ СТЪПАЛА (26.08.2026). Стълбицата свършваше на
            # „почти равностойни" и долното ѝ дъно беше 0.00 — тоест карта с
            # 20% получаваше думата за 50%. Прочетена жива карта:
            # „🎯 1 · победа Doncaster Rovers · 20% · почти равностойни".
            # Сега под 45% има две отделни думи и читателят вижда разликата.
            # Тази проверка не е украса: selftest обхожда P_DUMI и иска ВСЯКА
            # дума да е обяснена тук. Смени ли се стълбицата, съпортът пада.
            "процентът и думата до него: малък шанс · по-скоро не се сбъдва ·",
            "почти равностойни · мъничък превес · лек фаворит · ясен фаворит ·",
            "много ясен фаворит.",
            "",
            "Долните две значат точно каквото пише: <b>по-скоро не се сбъдва</b>",
            "е под една трета, а <b>малък шанс</b> е още по-малко. Такава карта",
            "излиза само когато мачът е интересен с нещо друго — не я четете",
            "като съвет да заложите.",
            "",
