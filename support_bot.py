...
FAQ = {
    ...
    "zvezdi": (
        ...
        NL.join([
            ...
            "процентът и думата до него: почти равностойни · лек фаворит ·",
            "ясен фаворит.",
            "",
    ...
    "tishina": (
        ...
        NL.join([
            ...
            "",
            "Няма карта, когато:",
            "• най-вероятният изход е под <b>45%</b> — да посочим страна, за",
            "  която сами казваме, че губи по-често, е безсмислено",
