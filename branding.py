...
ROOMS = [
    ...
    (6, "bask", "🏀 БАСКЕТБОЛ", "НБА, ВНБА и колежанските",
     ["Над/под точки и очакван резултат", "Темпо и ефективност — числата зад мача", "Нощната смяна отвъд океана"], "blue"),
    (7, "tt", "🏓 ТЕНИС НА МАСА", "Само сериозните турнири (WTT/ITTF)",
     ["Без нагласени лиги", "Процент победи за последните 18 месеца", "Честни прогнози, не гаранции"], "blue"),
