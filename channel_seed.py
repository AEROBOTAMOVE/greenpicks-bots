...
WELCOME = block(
    ...
    "на съперника. До всяко число стои извадката, от която е сметнато: „6+5 "
    "мача“ и „30+28 мача“ не тежат еднакво. Тънки данни — няма прогноза. Нищо "
    "не се трие: сгрешеното стои до познатото.",
    "",
    "Каналът е тих — тук пише само човекът зад фишовете. Живото е в групата: "
    "прогнозите на бота денонощно, срещите по спорт, новините и резултатите. "
    "Всяка стая има точно една задача. 👇 Влизането е от бутона.",
    "",
    "🆘 " + SUP + "   ·   🔞 18+")
