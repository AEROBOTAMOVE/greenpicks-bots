...
def selftest():
    ...
    check("редът за залога излиза", "залог" in _zr1)
    check("и казва, че е РАВЕН за всяка карта", "равен" in _zr1)
    ...
    # 🔴 И ЧЕ СТИГА ДО КАРТАТА
    check("редът за залога стига до КАРТАТА",
