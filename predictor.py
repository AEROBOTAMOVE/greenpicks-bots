...
def selftest():
    ...
    check("пазарът дава своето число", "пазарът дава" in _t_v)
    check("и то е в проценти, не коефициент", "55%" in _t_v)
    ...
    check("при съгласие се казва същото",
          "мислим същото" in card(_an_edn, now))
