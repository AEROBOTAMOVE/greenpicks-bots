...
VAZHNI = (
    ...
    # 🔴 ДОБАВЕН 16.09.2026 — живите футболни резултати (API-Football). Носи
    # продукт: секцията «На живо сега» в платформата и живото в стаите. Имаше
    # часовник (*/20), но никой не го гледаше — и точно това счупи пазача
    # (32 поредни провала: «никой с часовник не е забравен: zhivo.yml»).
    ("zhivo.yml", "живите футболни резултати на живо"),
