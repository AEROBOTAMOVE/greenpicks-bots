...
Измерено на живо 18.08.2026 срещу guest слоя на Pinnacle:
  ...
  🏀 баскетбол      12 лиги                                        ✅
  ⚽ футбол         154 лиги                                       ✅
  🏓 тенис на маса  нула мача ДНЕС — календарна дупка, не отказ     ❓
  🏐 волейбол       нула мача ДНЕС — вратата работи, пазар няма     ❓
...
#
# 🔴 ПОПРАВКА НА СОБСТВЕНАТА МИ ПРЕЦЕНКА (18.08.2026). Първо изключих
# волейбола, защото /sports/34/leagues върна 401. Но адресите, които РЕАЛНО
# ползваме — /matchups и /markets/straight — връщат 200 с празен списък.
# Тоест вратата е отворена; просто днес няма нито един волейболен мач в целия
# свят при тях. Същото важи за тениса на маса.
SPORT_ID = {
    "tennis": 33,
    "mma": 22,
    "tabletennis": 32,
