...
ZADALZHITELNI = {
    ...
    # 🎯 KAMBI — коефициенти по ТУРНИР (08.09.2026). Тези три носят цялата
    # разлика: имената се четат от събитието (при 1X2 изходите пишат «1»/«X»),
    # коефициентите се четат ПО ТИП (редът им не е обещан от никого), а
    # дървото дава 85 събития там, където списъкът дава 32.
    "kambi_ceni.py": [
        ("imena_ot_sabitie", "имената идват от homeName/awayName",
         "08.09.2026 — при 1X2 outcome.label е «1»/«X»; хокеят даваше 0 цени"),
        ("koef_po_tip", "коефициентите се четат по OT_ONE/OT_TWO/OT_CROSS",
         "08.09.2026 — редът на изходите не е обещан; обърнат ред обръщаше цените"),
        ("turniri", "пита се ДЪРВОТО, не списъкът «предстоящи скоро»",
         "08.09.2026 — listView дава 32 събития, дървото 85, вкл. WTT"),
    ],
    "zalozhimo.py": [
...
NE_BIVA_MARTVI = {
    ...
    # 🎯 Нов източник на коефициенти (08.09.2026). Спре ли да се вика,
    # тенисът на маса и хокеят тихо остават без числа — а точно това
    ...
    "betano.py": ["ceni_za", "sabitiya", "turniri", "imena_ot_sabitie",
                  ...
                  # 🔴 08.09.2026: двата извора ПРЕВЕЖДАТ държавите.
                  # Без таблицата се свързваха 5 от 23 и националните
                  # мачове — най-търгуваните в офертата — оставаха без цена.
                  "darzhava"],
