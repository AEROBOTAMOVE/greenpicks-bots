...
def obshto_dosega_text(now, rows):
    ...
    if not ots:
        return NL.join([
            ...
            "",
            "Още нищо не е отсъдено — " + str(pusnati) + " чакат мачовете си.",
            "",
            "\U0001f7e2 THE GREEN ROOM"])
    ...
    return NL.join([
        ...
        "",
        "<b>" + str(pusnati) + "</b> пуснати · <b>" + str(len(ots))
        + "</b> с резултат",
        "✅ <b>" + str(poz) + "</b> " + ("позната" if poz == 1 else "познати")
        + " · ❌ <b>" + str(zag) + "</b> "
        + ("загубена" if zag == 1 else "загубени")
